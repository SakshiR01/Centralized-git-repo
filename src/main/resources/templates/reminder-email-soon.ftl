...
<body>
<div style="position: relative; width: 650px; height: 800px; margin: auto; background-size:cover; background-image: url('cid:background');">
    ...
    <span style="position: relative; font-family: 'Poppins',sans-serif; font-style: normal; font-weight: 500; font-size: 22px; line-height: 40px;   letter-spacing: 0.02em; color: #B361B3; margin: 0 auto">
            ${EmailReminderTemplate.eventName} event is ending soon</span>
    </div>

    <div style="position: relative; width: 551px; height: 349px; background: #FFFFFF; border-radius: 16px; margin: 32px auto; padding: 28px;">
        ...
        <div style="position: relative; width: 491px; height: 150px; font-family: 'Poppins',sans-serif; font-style: normal; font-weight: normal; font-size: 15px; line-height: 22px; letter-spacing: 0.02em; color: rgba(0, 0, 0, 0.6); margin: 0 auto;">
            We are less than a week away to close our event  <span style=" color: #B361B3;">'${EmailReminderTemplate.eventName}'</span>.
            ...
            <br>
            <span
                    style="font-family: 'Poppins',sans-serif; font-style: normal; font-weight: 500; font-size: 14px; line-height: 21px; text-align: center; letter-spacing: 0.02em; color: #B361B3;">Contripoint Team!</span>
        </div>
    </div>
</div>
</body>
